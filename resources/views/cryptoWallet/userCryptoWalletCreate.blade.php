                ...
                <div class="box-body">
                    <form class="form form-horizontal" role="form" method="POST" action="{{ @$editFlag ? url("user/cryptoWallet/$userCryptoWallet->id") : url('user/cryptoWallet') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{ $errors->has('crypto_wallet_currency_id') ? 'has-error' : '' }}"
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="crypto_wallet_currency_id" required disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group {{ $errors->has('crypto_wallet_address') ? 'has-error' : '' }}">
                                    <div class="col-sm-12">
                                        <input class="form-control input-lg" type="text" name="crypto_wallet_address" value="{{ $userCryptoWallet->crypto_wallet_address ?? old('crypto_wallet_address') }}"
                                               placeholder="数字钱包地址" disabled>
                        ...
                        <div class="form-group {{ $errors->has('crypto_wallet_description') ? 'has-error' : '' }}">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control" name="crypto_wallet_description" rows="5"
                                          placeholder="描述信息" disabled>{{ $userCryptoWallet->crypto_wallet_description ?? old('crypto_wallet_description') }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <a href="{{ url('user/cryptoWallet') }}" class="btn btn-default pull-right">返回</a>
